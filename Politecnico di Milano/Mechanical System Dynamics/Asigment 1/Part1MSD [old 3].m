...
w1=X(1,1)*sin(gamma(1)*x)+X(2,1)*cos(gamma(1)*x)+X(3,1)*sinh(gamma(1)*x)+X(4,1)*cosh(gamma(1)*x)
w2=X(1,2)*sin(gamma(2)*x)+X(2,2)*cos(gamma(2)*x)+X(3,2)*sinh(gamma(2)*x)+X(4,2)*cosh(gamma(2)*x)
w3=X(1,3)*sin(gamma(3)*x)+X(2,3)*cos(gamma(3)*x)+X(3,3)*sinh(gamma(3)*x)+X(4,3)*cosh(gamma(3)*x)
w4=X(1,4)*sin(gamma(4)*x)+X(2,4)*cos(gamma(4)*x)+X(3,4)*sinh(gamma(4)*x)+X(4,4)*cosh(gamma(4)*x)
w5=X(1,5)*sin(gamma(5)*x)+X(2,5)*cos(gamma(5)*x)+X(3,5)*sinh(gamma(5)*x)+X(4,5)*cosh(gamma(5)*x)
