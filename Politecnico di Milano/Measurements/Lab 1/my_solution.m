...
clear
clc
%% 1-Displays a dialog window to choose the file to open ( uigetfile
[filename, pathname]=uigetfile; %open windows UI to open file

%% 2-load the file 

cd(pathname); %change directory to the right one

load(filename); %load the data onto matlab
